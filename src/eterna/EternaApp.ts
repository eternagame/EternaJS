...
interface EternaAppParams {
    ...
    noGame?: boolean;
    experimentalFeatures?: typeof Eterna.experimentalFeatures;
}
...
export default class EternaApp extends FlashbangApp {
    constructor(params: EternaAppParams) {
        ...
        params.experimentalFeatures = params.experimentalFeatures || [];
    ...
    public async loadPoseEdit(puzzleOrID: number | Puzzle, params: PoseEditParams) {
        ...
        const autoSaveData = await Eterna.saveManager.load(PoseEditMode.savedDataTokenName(puzzle.nodeID));
