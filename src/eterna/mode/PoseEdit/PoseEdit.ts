...
// import {Text, Texture, Point} from "pixi.js";
...
//         // this.addObject(this._docked_spec_box);
//
...
//         // this._docked_spec_box.addObject(x_button);
//
...
//         // this.addObject(this._bubble_curtain);
//
...
//
//             if (options[8] == true) {
//                 this._folder_button.text(this._puzzle.get_folder()); // set the actual one
...
//         this.layout_constraints();
//
//         this._docked_spec_box.set_size(new UDim(0, 0, Flashbang.stageWidth, this._offscreen_height - 340));
...
//         this._spec_box.addObject(cancel_button);
//
...
//
//         this._tools_container.set_size(new UDim(0, 0, Flashbang.stageWidth, 104));
//
