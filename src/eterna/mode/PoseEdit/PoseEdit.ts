...
export class PoseEdit extends GameMode {
    ...
    public constructor() {
        ...
        // this._paste_button.set_text("Paste");
        // this._paste_button.scale_icon_to_text();
        // this._paste_button.set_tooltip("Type in a sequence");
        // this._paste_button.set_click_callback(() => {
        //     Application.instance.add_lock("PASTESEQUENCE");
        //     this._paste_field.set_hotkeys(KeyCode.KEY_NONE, "", KeyCode.KEY_ESC, "Esc");
        //     Application.instance.get_modal_container().add_object(this._paste_field);
        // });

        // this._copy_button = new GameButton(14, BitmapManager.get_bitmap(BitmapManager.ImgCopy), 0, 0, true);
        // this._copy_button.set_text("Copy");
        // this._copy_button.scale_icon_to_text();
        // this._copy_button.set_tooltip("Copy the current sequence");
        // this._copy_button.set_click_callback(() => {
        ...
        // this._view_options_button = new GameButton(14, BitmapManager.get_bitmap(BitmapManager.ImgSettings));
        // this._view_options_button.set_text("Settings");
        // this._view_options_button.scale_icon_to_text();
        // this._view_options_button.set_tooltip("Game options");
        ...
        //         state_dict[PuzzleEvent.PUZEVENT_MODE_CHANGE] = PoseEdit.POSESTATE_PIP;
        ...
        //     .hotkey(KeyCode.KeyF);
        // this._freeze_button.set_click_callback(() => {
        //     this.toggle_freeze();
        // });
        ...
        // this._pair_swap_button = new GameButton(22, BitmapManager.get_bitmap(BitmapManager.ImgSwap));
        // this._pair_swap_button.set_states(BitmapManager.get_bitmap(BitmapManager.ImgSwap),
        //     BitmapManager.get_bitmap(BitmapManager.ImgSwapOver),
        //     null,
        //     BitmapManager.get_bitmap(BitmapManager.ImgSwapSelect),
        //     null);
        // this._pair_swap_button.set_click_callback(this.on_click_P);
        // this._pair_swap_button.set_hotkey(KeyCode.KEY_5, false, "5");
        // this._pair_swap_button.set_tooltip("Swap paired bases.");
        // this._tools_container.add_object(this._pair_swap_button);
        ...
        // this._spec_button = new GameButton(14, BitmapManager.get_bitmap(BitmapManager.ImgSpec));
        // this._spec_button.set_text("Specs");
        // this._spec_button.scale_icon_to_text();
        // this._spec_button.set_tooltip("View RNA's melting point, dotplot and other specs");
        // this._spec_button.set_click_callback(this.show_spec);
        // this._spec_button.set_hotkey(KeyCode.KEY_S, false, "s");
        //
        // this._spec_box = new SpecBox();
        // this._spec_box.set_pos(new UDim(0.15, 0.15, 0, 0));
        // this._spec_box.set_size(new UDim(0.7, 0.7, 0, 0));
        //
        // this._docked_spec_box = new SpecBox(true);
        // this._docked_spec_box.set_pos(new UDim(0, 0, 15, 190));
        // this._docked_spec_box.set_size(new UDim(0, 0, 155, 251));
        // this._docked_spec_box.visible = false;
        // this.add_object(this._docked_spec_box);

        // let x_button: GameButton = new GameButton(22, BitmapManager.get_bitmap(BitmapManager.ImgMaximize));
        // x_button.set_tooltip("Re-maximize");
        // x_button.set_use_response_animation(false);
        // x_button.set_click_callback(() => {
        //     this._docked_spec_box.visible = false;
        //     this.show_spec();
        // });
        // x_button.set_pos(new UDim(1, 0, -22, 5));
        // x_button.set_hotkey(KeyCode.KEY_M, false, "m");
        // this._docked_spec_box.add_object(x_button);
        ...
        // let base_data = BitmapManager.get_bitmap(BitmapManager.ImgFile);
        // this._view_solutions_button = new GameButton(14, base_data);
        // this._view_solutions_button.set_text("Designs");
        // this._view_solutions_button.scale_icon_to_text();
        // this._view_solutions_button.set_tooltip("View all submitted designs for this puzzle.");
        // this._view_solutions_button.set_click_callback(() => {
        //     Application.instance.transit_game_mode(Eterna.GAMESTATE_DESIGN_BROWSER, [this._puzzle.get_node_id()]);
        // });
        //
        // base_data = BitmapManager.get_bitmap(BitmapManager.ShapeImg);
        // this._folder_button = new GameButton(22, base_data);
        // this._folder_button.set_text("-");
        ...
        //
        // base_data = BitmapManager.get_bitmap(BitmapManager.ImgReset);
        // this._retry_button = new GameButton(14, base_data);
        // this._retry_button.set_text("Reset");
        // this._retry_button.scale_icon_to_text();
        // this._retry_button.set_tooltip("Reset and try this puzzle again.");
        // this._retry_button.set_click_callback(this.ask_retry);
        //
        ...
        this._ui_highlight = new GameObject;
        this.add_object(this._ui_highlight);
        ...
        this.add_object(this._constraints_container);

        /// Puzzle event must be at the top
        this._puzzle_events = new PuzzleEvent;
        Application.instance.get_front_object_container().add_object(this._puzzle_events);

        this._game_stamp = new GameBitmap(null);
        this._game_stamp.visible = false;
        this.add_object(this._game_stamp);

        this._exit_button = new GameButton(22, BitmapUtil.scale_by(BitmapManager.get_bitmap(BitmapManager.ImgNextInside), 0.3));
        this._exit_button.set_pos(new UDim(1, 1, -85, -60));
        this._exit_button.set_click_callback(this.exit_puzzle);
        this._exit_button.set_use_response_animation(false);
        this._exit_button.visible = false;

        let native_button: GameButton = new GameButton(22, BitmapManager.get_bitmap(BitmapManager.ImgNative), -2, -2, true);
        native_button.set_pos(new UDim(0.0, 0, 13, 15));
        native_button.set_states(BitmapManager.get_bitmap(BitmapManager.ImgNative),
            BitmapManager.get_bitmap(BitmapManager.ImgNativeOver),
            null,
            BitmapManager.get_bitmap(BitmapManager.ImgNativeSelected),
            null);
        native_button.set_tooltip("Natural Mode. RNA folds into the most stable shape.");
        this._native_button = native_button;
        this._tools_container.add_object(native_button);

        let target_button: GameButton = new GameButton(22, BitmapManager.get_bitmap(BitmapManager.ImgTarget), -4, -2, true);
        target_button.set_states(BitmapManager.get_bitmap(BitmapManager.ImgTarget),
            BitmapManager.get_bitmap(BitmapManager.ImgTargetOver),
            null,
            BitmapManager.get_bitmap(BitmapManager.ImgTargetSelected),
            null);
        target_button.set_tooltip("Target Mode. RNA freezes into the desired shape.");
        this._target_button = target_button;
        this._tools_container.add_object(target_button);

        this._native_button.set_click_callback(() => {
            this.toggle_posestate();
        });

        this._target_button.set_click_callback(() => {
            this.toggle_posestate();
        });

        /*
		//kws4679 add
		_edit_bar = new EditBar();
		_edit_bar.initAddBaseButton();
		//_edit_bar.initAddPairButton();		curruently not support add pair
		_edit_bar.initDeleteButton();

		_edit_bar.set_pos(new UDim(0.7,0.9,30,-145));
		//add_object(_edit_bar);

		_edit_bar.set_on_click_addbase_cb(on_click_addbase);
		_edit_bar.set_on_click_addpair_cb(on_click_addpair);
		_edit_bar.set_on_click_delete_cb(on_click_delete);
		_edit_bar.do_layout();
*/

        this._ll_menu = new EternaMenu(EternaMenu.MENU_STYLE_PULLUP);
        this._boosters_button = new GameButton(12, BitmapManager.get_bitmap(BitmapManager.NovaBoosters), 0, 0, true);

        let bn: GameButton = new GameButton(12, BitmapManager.get_bitmap(BitmapManager.NovaMenu), 0, 0, true);
        this._ll_menu.add_menu_button(bn);
        this._tools_container.add_object(this._ll_menu);

        this._script_hooks = false;
        this._setter_hooks = false;

        this._scriptbar = new ActionBar(50);
        this.add_object(this._scriptbar);

        this._nid_field = new Text(Fonts.arial(16, true), false, true);
        this._nid_field.set_size(new UDim(0, 0, 100, 20));

        this._run_button = new GameButton(22, BitmapManager.get_bitmap(BitmapManager.MingFold), -2, -2, true);

        this._run_status = Fonts.arial("idle", 16).bold().color(0xC0C0C0).build();
        this._run_status.set_autosize(false, true);
        this._run_status.set_size(new UDim(0, 0, 200, 20));
        ...
        this._view_options_cmi = null;
        this._view_solutions_cmi = null;
        this._submit_cmi = null;
        this._spec_cmi = null;
        this._reset_cmi = null;
        this._copy_cmi = null;
        this._paste_cmi = null;
        this._beam_cmi = null;

        this._next_design_cb = null;
        this._prev_design_cb = null;
        ...
        this._asynch_text = new Text(Fonts.arial(12, true));
        this._asynch_text.set_text("eterna.folding...");
        this._asynch_text.set_pos(new UDim(0, 0, 17, 200));
    ...
    public set_next_design_cb(cb: Function): void {
        this._next_design_cb = cb;
    }

    public set_prev_design_cb(cb: Function): void {
    ...
    public set_puzzle_state(newstate: number): void {
        ...
        //     let state_dict: Map<any, any> = new Map();
        //     state_dict[PuzzleEvent.PUZEVENT_TRANSIT_TO] = newstate;
        //     this._puzzle_events.process_events(state_dict);
        // }
    }
    ...
    public onPaletteTargetSelected(type: PaletteTargetType): void {
        ...
        //     states[PuzzleEvent.PUZEVENT_SET_PALLETE] = baseType;
    ...
    public on_click_hint(): void {
        if (this._hint_box.visible) {
            this._hint_box.visible = false;
        } else {
            this._hint_box.set_panel_title("Hint"); // by " + _puzzle.get_coauthor());
            this._hint_text.set_text(this._puzzle.get_hint());
            this._hint_text.set_autosize(false, false, 400);
            this._hint_text.set_pos(new UDim(0, 0, 10, 38));
            let h: number = this._hint_text.text_height();
            this._hint_box.set_size(new UDim(0, 0, 420, h + 46));
            this._hint_box.set_pos(new UDim(1, 1, -440, -140 - h));
            this._hint_box.visible = true;
        }
    }
    ...
    public restart_from(seq: string): void {
        ...
        let restart_cb: Function = (fd: any[]) => {
            Application.instance.get_modal_container().remove_object(this._asynch_text);
        ...
        if (sol != null && this._puzzle.has_target_type("multistrand")) {
            this._asynch_text.set_text("retrieving...");
            Application.instance.set_blocker_opacity(0.2);
            Application.instance.add_lock("FOLDING");
            Application.instance.get_modal_container().add_object(this._asynch_text);

            sol.query_fold_data(restart_cb);
        } else {
            restart_cb(null);
        }
    ...
    public set_puzzle(puz: Puzzle, init_seq: any[], is_reset: boolean = false): void {
        this._puzzle = puz;

        let pose_fields: any[] = [];

        let target_secstructs: any[] = puz.get_secstructs();
        let target_conditions: any[] = puz.get_target_conditions();

        let before_reset: any[] = null;
        if (is_reset) {
        ...
        let bind_mousedown_event: Function = function (pose: Pose2D, index: number): void {
            pose.set_start_mousedown_callback(function (e: MouseEvent, closest_dist: number, closest_index: number): void {
                for (let ii: number = 0; ii < pose_fields.length; ++ii) {
                    ...
                    if (index == ii) pose.on_pose_mouse_down(e, closest_index);
                    else pose.on_pose_mouse_down_propagate(e, closest_index);
                }
            });
        };
        ...
        if (options[12] == true)
            this._tools_container.add_object(this._freeze_button);

        this.add_object(this._tools_container);
        this.set_toolbar_autohide(options[11] == true);

        if (this._toggle_bar != null) {
            this._tools_container.remove_object(this._toggle_bar);
        ...
        if (target_secstructs.length > 1) {
            ...
            this._toggle_bar = new ToggleBar(target_secstructs.length, this.change_target);
            this._tools_container.add_object(this._toggle_bar);
        }
        ...
        if (this._is_databrowser_mode)
            this._pose_state = (PoseEdit.POSESTATE_NATIVE);
        else if (default_mode == "TARGET")
            this._pose_state = (PoseEdit.POSESTATE_TARGET);
        else if (default_mode == "FROZEN")
            this._pose_state = (PoseEdit.POSESTATE_FROZEN);
        else
            this._pose_state = (PoseEdit.POSESTATE_NATIVE);
        ...
        this._exit_button.visible = false;
        this.add_object(this._exit_button);
        ...
        this._constraints_container.visible = true && this._override_show_constraints;
        ...
        this._constraints_container.remove_all();
        this._constraint_boxes = [];
        ...
        if (num_constraints > 0) {
            ...
            if (this._constraint_boxes.length < num_constraints / 2) {
                ...
                for (let ii = orig_boxes; ii < num_constraints / 2; ii++) {
                    ...
                    this._constraints_container.add_object(newbox);
                }
            }
        ...
        let pairs: any[] = EPars.parenthesis_to_pair_array(puz.get_secstruct());

        /// Setup Action bar
        this._scriptbar.clear_items(false);

        if (puz.is_undo_zoom_allowed()) {
            this._tools_container.add_object(this._undo_button);
            this._tools_container.add_object(this._redo_button);
            this._tools_container.add_object(this._zoom_out_button);
            this._tools_container.add_object(this._zoom_in_button);
        }
        ...
        if (puz.get_puzzle_type() == "Experimental") {
            ...
            this._tools_container.add_object(this._submit_button);
            this._ll_menu.add_sub_menu_button(0, this._spec_button);

            if (options[8] == true) {
                this._folder_button.set_text(this._puzzle.get_folder()); // set the actual one
        ...
        if (puz.get_secstructs().length > 1)
            this._tools_container.add_object(this._pip_button);

        if (puz.is_pallete_allowed()) {
            if (puz.is_pair_brush_allowed()) {
                this._palette.change_default_mode();
                this._pair_swap_button.set_visible(true);
            } else {
                this._palette.change_no_pair_mode();
                this._pair_swap_button.set_visible(false);
            }
        } else {
            this._palette.set_disabled(true);
        }

        let hint_txt: string = puz.get_hint();
        if (hint_txt != null) {
            this._hint_button.set_visible(true);
        } else {
            this._hint_button.set_visible(false);
        }

        let k: number;
        for (k = 0; k < this._dyn_paint_tools.length; k++) {
            this._tools_container.remove_object(this._dyn_paint_tools[k]);
        }
        this._dyn_paint_tools = [];
        for (k = 0; k < this._dyn_action_tools.length; k++) {
            this._ll_menu.remove_button(this._dyn_action_tools[k]);
        }
        this._dyn_action_tools = [];

        this._yt_id = null;
        let obj: Object = puz.get_boosters();
        let booster: Booster;

        let missionDescriptionOverride: string = null;
        if (obj) {
            if (obj['paint_tools'] != null) {
                for (k = 0; k < obj.paint_tools.length; k++) {
                    booster = new Booster(this, obj.paint_tools[k], (me: Booster, dummy: number) => {
                        me.on_load();
                        ...
                        this._tools_container.add_object(button);
                        this.layout_bars();
                    });
                }
            }
            if (obj['actions'] != null) {
                ...
                for (k = 0; k < obj.actions.length; k++) {
                    obj.actions[k]['menu_index'] = k;
                    booster = new Booster(this, obj.actions[k], (me: Booster, midx: number = 0) => {
        ...
        this._mission_container.add_object(this._mission_screen);
        ...
        this.set_puzzle_state(PoseEdit.PUZSTATE_SETUP);
    ...
    public on_click_run(): void {
        ...
        let nid: string = this._nid_field.get_text();
        if (nid.length == 0) return;
        this.trace_js(nid);

        this._run_status.set_text_color(0xC0C0C0);
        this._run_status.set_text("running...");
        ...
        let set_end_callback: Function = function (pose: PoseEdit, sid: string): void {
    ...
    public layout_constraints(): void {
        ...
        for (let ii: number = 1; ii < n; ii++) {
            rel_x = (Number(ii) / n) * this._offscreen_width + 17;
    ...
    public on_key_down(key: number, ctrl: boolean, shift: boolean): boolean {
        if (!ctrl && key == KeyCode.KEY_N) {
            Application.instance.get_application_gui("View options").toggle_numbering();
            return true;
        }
        if (!ctrl && key == KeyCode.KEY_G) {
            Application.instance.get_application_gui("View options").toggle_energy_display();
            return true;
        }
        if (!ctrl && key == KeyCode.KEY_S) {
            this.show_spec();
            return true;
        }
        if (ctrl && key == KeyCode.KEY_Z) {
            this.move_undo_stack_to_last_stable();
            return true;
        }
        if (this._stack_level == 0 && key == KeyCode.KEY_D && this._next_design_cb != null) {
            this._next_design_cb();
            return true;
        }
        if (this._stack_level == 0 && key == KeyCode.KEY_U && this._prev_design_cb != null) {
    ...
    public update(current_time: number, paused: boolean): void {
        ...
        while (elapsed < 50) { // FIXME: arbitrary
            if (this._op_queue.length > 0) {
                let op: Object = this._op_queue.shift();
                op.fn.apply((op.objref ? op.objref : this), op.arg);
                if (op.sn) {
                    this._asynch_text.set_text("eterna.folding " + op.sn + " of " + this._target_pairs.length + " (" + this._op_queue.length + ")");
                }
            } else
                break;
            elapsed = (new Date).time - current_time;
        }

        // FIXME: what do we still need this for?
        //if (_puz_state == PUZSTATE_CLEARED)
        //	return;
    }
    ...
    public set_show_constraints(do_show: boolean): void {
        ...
        if (this._constraints_container != null) {
            this._constraints_container.visible = this._constraints_container.visible && this._override_show_constraints;
        }
    }
    ...
    protected on_set_pip(pip_mode: boolean): void {
        AutosaveManager.instance.saveObjects([pip_mode], "PIP-pref-" + Application.instance.get_player_id());

        let ii: number;

        if (pip_mode) {
            if (this._toggle_bar != null)
                this._toggle_bar.visible = false;
            this._target_name.visible = false;
            ...
            if (this._pose_state == PoseEdit.POSESTATE_NATIVE) {
                this.set_to_native_mode();
            } else if (this._pose_state == PoseEdit.POSESTATE_TARGET) {
                this.set_to_target_mode();
            } else {
            ...
            for (ii = 0; ii < this._poses.length; ii++) {
                min_zoom = Math.max(min_zoom, this._poses[ii].compute_default_zoom_level());
            }
            for (ii = 0; ii < this._poses.length; ii++) {
                this._poses[ii].set_zoom_level(min_zoom);
            }

        } else {

            if (this._toggle_bar != null) {
                this._toggle_bar.visible = true;
                this._target_name.visible = true;
            }
    ...
    protected on_resize(): void {
        ...
        this._docked_spec_box.set_size(new UDim(0, 0, this._offscreen_width, this._offscreen_height - 340));
        let s: number = this._docked_spec_box.getPlotSize();
        this._docked_spec_box.set_size(new UDim(0, 0, s + 55, s * 2 + 51));
    }
    ...
    private keep_playing(): void {
        ...
        this._exit_button.alpha = 0;
        this._exit_button.visible = true;
        this._exit_button.set_animator(new GameAnimatorFader(0, 1, 0.3, false));
    ...
    private change_target(target_index: number): void {
        if (this._puzzle.get_puzzle_type() == "SwitchBasic" && this._waiting_for_input) {
            let state_dict: Map<any, any> = new Map();
            if (target_index == 1)
                state_dict[PuzzleEvent.PUZEVENT_MODE_CHANGE] = PoseEdit.POSESTATE_SECOND;
            this._puzzle_events.process_events(state_dict);
        }
        ...
        if (this._target_conditions && this._target_conditions[this._current_target_index]) {
            if (this._target_conditions[this._current_target_index]['state_name'] != null) {
                this._target_name.set_text(this._target_conditions[this._current_target_index]['state_name']);
            }
        }
    ...
    private get_forced_highlights(target_index: number): any[] {
        let elems: any[] = null;

        if (this._target_conditions) {
            let max_len: number = this._poses[target_index].get_sequence().length;
            for (let ii: number = 0; ii < this._poses.length; ii++) {
                if (ii == target_index) continue;
                if (this._target_conditions[ii]['force_struct'] == null) continue;
                if (elems == null) {
                    elems = [];
                }
                let curr: number = 1;
                let forced: any[] = EPars.parenthesis_to_forced_array(this._target_conditions[ii]['force_struct']);
                for (let jj = 0; jj < max_len && jj < forced.length; jj++) {
    ...
    private save_poses_markers_contexts(): void {
        let ii: number;
        for (ii = 0; ii < this._poses.length; ii++) this._poses[ii].save_markers_context();
    }

    private transform_poses_markers(): void {
        let ii: number;
        for (ii = 0; ii < this._poses.length; ii++) this._poses[ii].transform_markers();
    }
    ...
    private set_to_native_mode(trigger_modechange_event: boolean = true): void {
        ...
        if (this._puzzle.get_puzzle_type() == "Basic" && this._waiting_for_input && trigger_modechange_event) {
            let state_dict: Map<any, any> = new Map();
            state_dict[PuzzleEvent.PUZEVENT_MODE_CHANGE] = PoseEdit.POSESTATE_NATIVE;
            this._puzzle_events.process_events(state_dict);
        }
    ...
    private set_to_target_mode(trigger_modechange_event: boolean = true): void {
        ...
        if (this._puzzle.get_puzzle_type() == "Basic" && this._waiting_for_input && trigger_modechange_event) {
            let state_dict: Map<any, any> = new Map();
            state_dict[PuzzleEvent.PUZEVENT_MODE_CHANGE] = PoseEdit.POSESTATE_TARGET;
            this._puzzle_events.process_events(state_dict);
        }
    ...
    private toggle_posestate(): void {
        if (this._pose_state == PoseEdit.POSESTATE_TARGET) {
            this.set_to_native_mode();
        } else if (this._pose_state == PoseEdit.POSESTATE_NATIVE) {
            this.set_to_target_mode();
        } else {
    ...
    private toggle_freeze(): void {
        ...
        this._constraints_container.alpha = (this._is_frozen ? 0.25 : 1.0);
        this.set_show_total_energy(!this._is_frozen);

        this._undo_button.set_disabled(this._is_frozen);
        this._redo_button.set_disabled(this._is_frozen);
        this._freeze_button.set_selected(this._is_frozen);

        if (!this._is_frozen) { // we just "thawed", update
            this.pose_edit_by_target(this._current_target_index);
        }

        Application.instance.get_application_gui("Background").freeze_background(this._is_frozen);
    }
    ...
    private show_spec(): void {
        ...
        let cancel_button: GameButton = new GameButton(12);
        cancel_button.set_text("Ok");
        cancel_button.set_use_response_animation(false);
        cancel_button.set_states();
        cancel_button.set_style("nova");
        cancel_button.set_pos(new UDim(1, 1, -cancel_button.button_width() - 20, -cancel_button.button_height() - 20));
        this._spec_box.add_object(cancel_button);

        cancel_button.set_click_callback(() => {
            Application.instance.get_modal_container().remove_object(this._spec_box);
            Application.instance.remove_lock("SPEC");
            this._spec_button.set_hotkey(KeyCode.KEY_S, false, "s");
        });
        this._spec_button.unset_hotkey();
        cancel_button.set_hotkey(KeyCode.KEY_S, false, "s");
        cancel_button.set_tooltip("");

        let add_thumbnail_button: GameButton = new GameButton(12);
        add_thumbnail_button.set_text("Minimize Window");
        add_thumbnail_button.set_use_response_animation(false);
        add_thumbnail_button.set_states();
        add_thumbnail_button.set_style("nova");
        add_thumbnail_button.set_pos(new UDim(1, 1, -cancel_button.button_width() - 20 - add_thumbnail_button.button_width() - 20, -add_thumbnail_button.button_height() - 20));
        add_thumbnail_button.set_tooltip("Minimize");
        add_thumbnail_button.set_hotkey(KeyCode.KEY_M, false, "m");
        this._spec_box.add_object(add_thumbnail_button);

        add_thumbnail_button.set_click_callback(() => {
            this._docked_spec_box.set_spec(datablock);
            this._docked_spec_box.visible = true;
        ...
        Application.instance.get_modal_container().add_object(this._spec_box);
    }

    private update_docked_spec_box(): void {
        if (this._docked_spec_box.visible) {
            this.update_current_block_with_dot_and_melting_plot();
            let datablock: UndoBlock = this.get_current_undo_block();
            this._docked_spec_box.set_spec(datablock);
        }
    ...
    //     }
    //
    //     let elapsed: number = ((new Date).time - this._start_solving_time) / 1000.;
    ...
    private deselect_all_colorings(): void {
        ...
        for (let k: number = 0; k < this._dyn_paint_tools.length; k++) {
            this._dyn_paint_tools[k].set_selected(false);
        }
    }
    ...
    private disable_tools(disable: boolean): void {
        ...
        this._pair_swap_button.set_disabled(disable);
        for (let k: number = 0; k < this._dyn_paint_tools.length; k++) {
            this._dyn_paint_tools[k].set_disabled(disable);
        }
        this._scriptbar.set_disabled(disable);

        this._target_button.set_disabled(disable);
        this._native_button.set_disabled(disable);

        this._zoom_in_button.set_disabled(disable);
        this._zoom_out_button.set_disabled(disable);

        this._native_button.set_disabled(disable);
        this._target_button.set_disabled(disable);

        this._view_options_button.set_disabled(disable);
        if (this._pic_button) {
            this._pic_button.set_disabled(disable);
        }
        this._is_pic_disabled = disable;
        this._retry_button.set_disabled(disable);
        this._copy_button.set_disabled(disable);
        this._paste_button.set_disabled(disable);
        this._spec_button.set_disabled(disable);

        this._undo_button.set_disabled(disable);
        this._redo_button.set_disabled(disable);

        this._submit_button.set_disabled(disable);
        this._view_solutions_button.set_disabled(disable);

        if (this._hint_box.visible) {
            this._hint_box.visible = false;
        }
        this._hint_button.set_disabled(disable);

        this._folder_button.set_disabled(disable);
        this._freeze_button.set_disabled(disable);

        this._pip_button.set_disabled(disable);
    ...
    private start_countdown(): void {
        ...
        SoundManager.instance.play_bg(SoundManager.SOUND_MISSION,1);
        ...
        this.set_puzzle_state(PoseEdit.PUZSTATE_COUNTDOWN);
        ...
        for (ii = 0; ii < num_constraints / 2; ++ii) {
            this._constraints_container.remove_object(ConstraintBox(this._constraint_boxes[ii]));
        }
    ...
    private on_click_start_curtain(): void {
        ...
        for (let ii: number = 0; ii < num_constraints / 2; ii++) {
            ...
            this._constraints_container.add_object(ConstraintBox(this._constraint_boxes[ii]));
        }

        this._start_solving_time = (new Date).time;
    ...
    private start_playing(animate_constraints: boolean): void {
        ...
        this.set_puzzle_state(PoseEdit.PUZSTATE_GAME);
    ...
    private reset_autosave_data(): void {
        ...
        AutosaveManager.instance.saveObjects(null, token);
    }
    ...
    private autosave_data(e: Event): void {
        ...
        AutosaveManager.instance.saveObjects(objs, token);
    ...
    private transfer_to_puzzlemaker(): void {
        ...
        AutosaveManager.instance.saveObjects(objs, cookie);
    ...
    private autoload_data(): boolean {
        ...
        let beginning_sequence: any[] = this._puzzle.get_beginning_sequence();
        let locks: any[] = this._puzzle.get_puzzle_locks();
        ...
        let msecs: number = 0;
        let a: any[];
        let objs: any[] = AutosaveManager.instance.loadObjects(token);
        // no saved data
        if (objs == null) {
        ...
        for (ii = 0; ii < this._target_pairs[0].length; ii++) {
            if (locks[ii]) {
    ...
    private done_playing(cleared: boolean): void {
        if (this._puz_state == PoseEdit.PUZSTATE_CLEARED)
            return;

        this.disable_tools(true);
        this.set_puzzle_state(PoseEdit.PUZSTATE_CLEARED);
        ...
        if (cleared) {
            ...
            SoundManager.instance.play_bg(PoseEdit.GAMESOUND_PUZZLE_CLEAR, 0);
        } else {
            this.show_end_curtain();
        }
    }
    ...
    private set_puzzle_epilog(init_seq: any[], is_reset: boolean): void {

        if (is_reset) {
            let new_seq: any[] = this._puzzle.transform_sequence(this.get_current_undo_block(0).get_sequence(), 0);
        ...
        let pref: any[] = AutosaveManager.instance.loadObjects("PIP-pref-" + Application.instance.get_player_id());
        if (pref == null)
            this.set_pip(false);
        else
            this.set_pip(pref[0]);
        ...
        this.update_children_objects(new Date().time, true);
    ...
    private check_constraints(render: boolean = true): boolean {
        ...
        for (ii = 0; ii < constraints.length; ii += 2) {
            ...
            if (constraints[ii] == "GU") {
                ...
                if (this._target_conditions != null && this._target_conditions[target_index] != null) {
                    ...
                    if (ublk.get_oligo_order() != null) {
                        ...
                        if (np_map != null) {
                            let new_pairs: any[] = [];
                            let new_sc: any[] = [];
                            for (jj = 0; jj < native_pairs.length; jj++) {
                ...
                if (this._is_pip_mode && target_index > 0) {
                    ...
                    if (this._puz_state == PoseEdit.PUZSTATE_GAME || this._puz_state == PoseEdit.PUZSTATE_CLEARED)
                        box.visible = true;
                }
                ...
                for (jj = 0; jj < sequence.length; jj++) {
                ...
                if (ExternalInterface.available) {
                    ...
                    let set_end_callback: Function = function (pose: PoseEdit, sid: string, jj: number): void {
                        ExternalInterface.addCallback("_end" + sid, function (ret: Object): void {
                            let goal: string = "";
                            let name: string = "...";
                            let value: string = "";
        ...
        for (ii = 0; ii < this._poses.length; ii++) {
            jj = this._is_pip_mode ? ii : (ii == 0 ? this._current_target_index : ii);
            let restricted: any[];
        ...
        if (check_res && !old_check_res) {
            if (this._puzzle.get_puzzle_type() == "Experimental") {
                SoundManager.instance.play_se(PoseEdit.GAMESOUND_ALLCONDITIONS);
            } else if (this._puz_state != PoseEdit.PUZSTATE_GAME) {
                SoundManager.instance.play_se(PoseEdit.GAMESOUND_CONDITION);
            }
        } else if (play_condition_music) {
            SoundManager.instance.play_se(PoseEdit.GAMESOUND_CONDITION);
        } else if (play_decondition_music) {
            SoundManager.instance.play_se(PoseEdit.GAMESOUND_DECONDITION);
        }
    ...
    private update_score(): void {
        ...
        let undo_block: UndoBlock = this.get_current_undo_block();
        let sequence: any[] = undo_block.get_sequence();
        let best_pairs: any[] = undo_block.get_pairs(EPars.DEFAULT_TEMPERATURE);
        let ii: number;
        let nnfe: any[];
        ...
        if (!this._paused) {
            ...
            for (ii = 0; ii < this._poses.length; ii++) {
                if (ii == 0 && this._pose_state == PoseEdit.POSESTATE_NATIVE && !this._is_pip_mode) {
            ...
            for (ii = 0; ii < this._poses.length; ++ii) {
                if (ii == 0 && this._pose_state == PoseEdit.POSESTATE_TARGET && !this._is_pip_mode) {
                    this._poses[0].set_oligos(this.get_current_undo_block().get_target_oligos(),
        ...
        if (!this._is_frozen) {
            if (this._undo_button.visible)
                this._undo_button.set_disabled(this._stack_level < 1);
            if (this._redo_button.visible)
                this._redo_button.set_disabled(this._stack_level + 1 > this._stack_size - 1);
        }

        let was_satisfied: boolean = true;
        for (ii = 0; ii < this._puzzle.get_constraints().length; ii += 2) {
            was_satisfied && this. = ConstraintBox(this._constraint_boxes[ii / 2]).is_satisfied();
        }
        ...
        if (constraints_satisfied && is_there_temp_constraints) {
            state_dict[PuzzleEvent.PUZEVENT_TEMP_CLEARED] = true;
        }

        this._puzzle_events.process_events(state_dict);

        if (constraints_satisfied && !is_there_temp_constraints) {
            if (this._puzzle.get_puzzle_type() != "Experimental" && this._puz_state == PoseEdit.PUZSTATE_GAME) {
        ...
        if (target_index == 0 || !this._is_pip_mode) {
            ...
            for (let ii: number = 0; ii < constraints.length; ii += 2) {
                if (constraints[ii] == "SHAPE" && Number(constraints[ii + 1]) == target_index) {
                    box = ConstraintBox(this._constraint_boxes[ii / 2]);
                    break;
                }
            }
        } else {
    ...
    private pose_edit_by_target(target_index: number): void {
        ...
        let segments: any[] = this._poses[target_index].get_design_segments();
        let idx_map: any[] = this._poses[target_index].get_order_map(this._target_oligos_order[xx]);
        let jj: number;
        let structure_constraints: any[] = null;
        ...
        if (segments.length == 4
			...
			*/
            ...
            if (structure_constraints != null) {
                ...
                for (jj = segments[0]; jj <= segments[1] && dontcare_ok; jj++) {
                ...
                for (jj = segments[2]; jj <= segments[3] && dontcare_ok; jj++) {
                    if (structure_constraints[jj]) {
                        dontcare_ok = false;
                        continue;
                    }
                ...
                if (dontcare_ok && num_wrong == 0) {
                    if (num_unpaired == 0) {
                        for (jj = segments[0]; jj <= segments[1]; jj++) this._target_pairs[xx][jj] = -1;
                        for (jj = segments[2]; jj <= segments[3]; jj++) this._target_pairs[xx][jj] = -1;
                        SoundManager.instance.play_se(PoseEdit.GAMESOUND_RY);
                        ...
                        if (EPars.validate_parenthesis(EPars.pairs_array_to_parenthesis(this._target_pairs[xx]).slice(segments[1] + 1, segments[2]), false) == null) {
                            for (jj = segments[0]; jj <= segments[1]; jj++) this._target_pairs[xx][jj] = segments[3] - (jj - segments[0]);
                            for (jj = segments[2]; jj <= segments[3]; jj++) this._target_pairs[xx][jj] = segments[1] - (jj - segments[2]);
                            SoundManager.instance.play_se(PoseEdit.GAMESOUND_GB);
                            this.flash_constraint_for_target(xx);
                            this._poses[target_index].clear_design_struct();
                            ...
                            let new_order: any[] = [];
                            for (jj = 0; jj < this._target_oligos[xx].length; jj++) new_order.push(jj);
                            let more: boolean;
                            do {
                                ...
                                if (new_map != null) {
                                    ...
                                    for (jj = 0; jj < this._target_pairs[xx].length; jj++) {
        ...
        for (let ii: number = 0; ii < this._poses.length; ii++) {
            if (last_shifted_index > 0 && last_shifted_command >= 0) {
                ...
                if (anti_secstruct != null) {
                    let anti_pairs: any[] = EPars.parenthesis_to_pair_array(anti_secstruct);
                    let antiResult: Object = this._poses[ii].parse_command_with_pairs(last_shifted_command, last_shifted_index, anti_pairs);
                ...
                if (this._target_conditions[ii]['type'] == "aptamer") {
                    ...
                    if (last_shifted_command == EPars.RNABASE_ADD_BASE) {
                        ...
                        for (jj = 0; jj < binding_site.length; jj++) {
                    ...
                    /**
                     if (_is_pip_mode) {
						Pose2D(_poses[ii]).set_molecular_binding(_target_conditions[ii]['site'], _target_conditions[ii]['binding_pairs'], _target_conditions[ii]['bonus'] / 100.0);
					} else {
						if (ii == _current_target_index) {
							Pose2D(_poses[0]).set_molecular_binding(_target_conditions[ii]['site'], _target_conditions[ii]['binding_pairs'], _target_conditions[ii]['bonus'] / 100.0);
						}
					}
                     **/
                }
        ...
        let execfold_cb: Function = function (fd: any[]): void {
            ...
            if (fd != null) {
                ...
                if (this._pose_edit_by_target_cb != null) this._pose_edit_by_target_cb();
                return;
            }
        ...
        if (sol != null && this._puzzle.has_target_type("multistrand")) {
            ...
            sol.query_fold_data(execfold_cb);
        } else {
            execfold_cb(null);
        }
    }
    ...
    private pose_edit_by_target_do_fold(target_index: number): void {
        this._fold_start_time = new Date().time;
    ...
    private pose_edit_by_target_fold_target(ii: number): void {
        ...
        let seq: any[] = this._poses[ii].get_sequence();
    ...
    private pose_edit_by_target_epilog(target_index: number): void {
        ...
        let last_best_pairs: any[] = null;
        let best_pairs: any[] = last_best_pairs = this._seq_stacks[this._stack_level][target_index].get_pairs();
        ...
        if (last_best_pairs != null) {
            ...
            if (!this._poses[target_index].is_using_low_performance()) {
                ...
                for (let ii = 0; ii < best_pairs.length; ii++) {
                    if (pairs_diff[ii] > 0 && ((!is_shape_constrained && this._pose_state == PoseEdit.POSESTATE_NATIVE) || (best_pairs[ii] == this._target_pairs[target_index][ii]))) {
                        if (stack_start < 0) {
                            stack_start = ii;
        ...
        if (this._fold_total_time >= 1000.0 && this._puzzle.has_target_type("multistrand")) {
            ...
            if (sol != null && !sol.has_fold_data()) {
                ...
                GameClient.instance.update_solution_fold_data(sol.get_node_id(), fd, function (datastring: string): void {
        ...
        if (seq[4] == "3" && seq[9] != "3") {
            let state_dict: Map<any, any> = new Map();
            state_dict[PuzzleEvent.PUZEVENT_ON_POSE_CHANGE] = true;
            this._puzzle_events.process_events(state_dict);
        }
    }
    ...
    private set_start_curtain(show_curtain: boolean): void {
        ...
        //     this._mission_container.remove_object(this._mission_screen);
        // }
        // this._mission_container.add_object(this._mission_screen);
	...
	*/
    ...
    private show_end_curtain(): void {
        ...
        // }
        //
        // this.remove_object(this._mission_cleared);
    ...
    private layout_bars(): void {
        ...
        if (this._offscreen_width > whole_width) {
            let margin: number = (this._offscreen_width - whole_width) / 2.0;
            rel_x = margin / this._offscreen_width;
        }

        this._scriptbar.set_pos(new UDim(1.0, 1.0, -20 - this._scriptbar.get_bar_width(), -129));

        // Adjust positions of NOVA-Port UI
        let right_x_idx: number = 0;
        let left_x_idx: number = 0;

        this._tools_container.set_size(new UDim(0, 0, this._offscreen_width, 104));
        ...
        if (this._pair_swap_button && this._tools_container.contains(this._pair_swap_button)) {
            this._pair_swap_button.set_pos(new UDim(0.5, 1, right_x_idx + 4, -21 - this._pair_swap_button.button_height()));
            right_x_idx += (4 + this._pair_swap_button.button_width());
        }

        for (let k: number = 0; k < this._dyn_paint_tools.length; k++) {
            if (this._dyn_paint_tools[k] && this.contains(this._dyn_paint_tools[k])) {
                this._dyn_paint_tools[k].set_pos(new UDim(0.5, 1, right_x_idx + 4, -21 - this._dyn_paint_tools[k].button_height()));
                right_x_idx += (4 + this._dyn_paint_tools[k].button_width());
            }
        }

        right_x_idx += 20;
        if (this._zoom_in_button && this._tools_container.contains(this._zoom_in_button)) {
            this._zoom_in_button.set_pos(new UDim(0.5, 1, right_x_idx + 4, -21 - this._zoom_in_button.button_height()));
            right_x_idx += (4 + this._zoom_in_button.button_width());
        }
        if (this._zoom_out_button && this._tools_container.contains(this._zoom_out_button)) {
            this._zoom_out_button.set_pos(new UDim(0.5, 1, right_x_idx + 1, -21 - this._zoom_out_button.button_height()));
            right_x_idx += (1 + this._zoom_out_button.button_width());
        }
        if (this._undo_button && this._tools_container.contains(this._undo_button)) {
            this._undo_button.set_pos(new UDim(0.5, 1, right_x_idx + 4, -21 - this._undo_button.button_height()));
            right_x_idx += (4 + this._undo_button.button_width());
        }
        if (this._redo_button && this._tools_container.contains(this._redo_button)) {
            this._redo_button.set_pos(new UDim(0.5, 1, right_x_idx + 1, -21 - this._redo_button.button_height()));
            right_x_idx += (1 + this._redo_button.button_width());
        }
        if (this._hint_button && this._tools_container.contains(this._hint_button)) {
            this._hint_button.set_pos(new UDim(0.5, 1, right_x_idx + 4, -21 - this._hint_button.button_height()));
            right_x_idx += (4 + this._hint_button.button_width());
        }

        left_x_idx -= 20;
        if (this._target_button && this._tools_container.contains(this._target_button)) {
            this._target_button.set_pos(new UDim(0.5, 1, left_x_idx - 4 - this._target_button.button_width(), -21 - this._target_button.button_height()));
            left_x_idx -= (4 + this._target_button.button_width());
        }
        if (this._native_button && this._tools_container.contains(this._native_button)) {
            this._native_button.set_pos(new UDim(0.5, 1, left_x_idx - 1 - this._native_button.button_width(), -21 - this._native_button.button_height()));
            left_x_idx -= (1 + this._native_button.button_width());
        }
        if (this._pip_button && this._toggle_bar) {
            this._pip_button.set_pos(new UDim(0.5, 1, left_x_idx - 4 - this._pip_button.button_width(), -21 - this._pip_button.button_height()));
            left_x_idx -= (4 + this._pip_button.button_width());
        }
        if (this._freeze_button && this._tools_container.contains(this._freeze_button)) {
            this._freeze_button.set_pos(new UDim(0.5, 1, left_x_idx - 4 - this._freeze_button.button_width(), -21 - this._freeze_button.button_height()));
            left_x_idx -= (4 + this._freeze_button.button_width());
        }

        left_x_idx -= 20;
        if (this._submit_button && this._tools_container.contains(this._submit_button)) {
            this._submit_button.set_pos(new UDim(0.5, 1, left_x_idx - 4 - this._submit_button.button_width(), -21 - this._submit_button.button_height()));
            left_x_idx -= (4 + this._submit_button.button_width());
        }
        if (this._ll_menu && this._tools_container.contains(this._ll_menu)) {
            this._ll_menu.set_pos(new UDim(0.5, 1, left_x_idx - 4 - this._ll_menu.get_width(false), -21 - this._ll_menu.get_height()));
            left_x_idx -= (4 + this._ll_menu.width);
        }

        if (this._toggle_bar && this._zoom_in_button) {
            this._toggle_bar.set_pos(new UDim(0.5, 1, -this._toggle_bar.width / 2, -21 - this._zoom_in_button.button_height() - 5 - this._toggle_bar.height));
            this._target_name.set_pos(new UDim(0.5, 1, 5 + this._toggle_bar.width / 2, -21 - this._zoom_in_button.button_height() - 5 - this._toggle_bar.height + 1));
        }
    }
    ...
    private _pose_edit_by_target_cb: Function;
    ...
    /// UI highlight box
    private _ui_highlight: GameObject;
    /// Game Stamp
    private _game_stamp: Texture;
    // Mission Screens
    private _mission_screen: MissionScreen;
    private _mission_container: GameObject;
    // private _mission_cleared: MissionCleared;
    private _yt_id: string;
    /// Additional menu item
    private _menuitem: GameButton;
    /// Context menu items
    // private _view_options_cmi: ContextMenuItem;
    // private _view_solutions_cmi: ContextMenuItem;
    // private _submit_cmi: ContextMenuItem;
    // private _spec_cmi: ContextMenuItem;
    // private _reset_cmi: ContextMenuItem;
    // private _copy_cmi: ContextMenuItem;
    // private _paste_cmi: ContextMenuItem;
    // private _beam_cmi: ContextMenuItem;
    /// Scripts
    // private _scriptbar: ActionBar;
    private _nid_field: Text;
    private _run_button: GameButton;
    private _run_status: Text;
    private _script_hooks: boolean;
    private _setter_hooks: boolean;
    /// ROP presets
    private _rop_presets: any[];
    private _is_pic_disabled: boolean = false;
    // Design browser hooks
    private _next_design_cb: Function;
    private _prev_design_cb: Function;
    ...
    private static readonly GAMESOUND_PUZZLE_CLEAR: string = "PUZZLE_CLEAR";
    private static readonly GAMESOUND_BEXTRA: string = "BEXTRA";
    private static readonly GAMESOUND_YEXTRA: string = "YEXTRA";
    private static readonly GAMESOUND_REXTRA: string = "REXTRA";
    private static readonly GAMESOUND_GEXTRA: string = "GEXTRA";
    private static readonly GAMESOUND_ALLCONDITIONS: string = "ALLCONDITIONS";
    private static readonly GAMESOUND_CONDITION: string = "CONDITION";
    private static readonly GAMESOUND_DECONDITION: string = "DECONDITION";
    private static readonly GAMESOUND_GB: string = "GB";
    private static readonly GAMESOUND_RY: string = "RY";
}
