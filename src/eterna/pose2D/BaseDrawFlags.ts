...
export class BaseDrawFlags {
    ...
    public setStatic(val: boolean = true): BaseDrawFlags {
        this._flags = (val ? this._flags | BaseDrawFlags.STATIC : this._flags & ~BaseDrawFlags.STATIC);
        return this;
    }
