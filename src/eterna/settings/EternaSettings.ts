...
export default class EternaSettings extends Settings {
    ...
    public readonly designBrowserOnlySelectedVisible: Setting<boolean>;
    ...
    constructor() {
        ...
        this.designBrowserOnlySelectedVisible = this.setting<boolean>('designBrowserOnlySelectedVisible', false);
