...
export default class MissionIntroConstraints extends ContainerObject {
    ...
    constructor(props: MissionIntroConstraintsProps) {
        ...
        this._leftButton.display.position = new Point(0, constraintHeight / 2);
        ...
        this._rightButton.display.position = new Point(0, constraintHeight / 2);
    ...
    public updateLayout(_maxWidth: number) {
        ...
        for (let i = 0; i < this._pageCount; ++i) {
            ...
            dot.visible = true;
            dot.position.x = i * (dot.width + theme.spacing);
        }
        // Hide unused dots
        ...
        const dotsWidth = this._pageCount * (this._activePageDot.width + theme.spacing);
    ...
    private updatePages() {
        ...
        let xWalker = this._leftButton.container.width + theme.spacing;
        ...
        this._activePageDot.position.x = this._dots.container.position.x
            + this._currentPage * (this._activePageDot.width + theme.spacing);
    }
}
