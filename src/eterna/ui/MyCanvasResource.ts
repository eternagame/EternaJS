import { ALPHA_MODES, BaseTexture, GLTexture, Renderer, Resource} from "pixi.js";
...
export default class MyCanvasResource extends Resource {
    ...
    upload(renderer: Renderer, baseTexture: BaseTexture, glTexture: GLTexture): boolean {
        ...
        gl.texImage2D(baseTexture.target, 0, baseTexture.format, baseTexture.format, baseTexture.type, canvas2);
